...
const ServerEditor:React.FC<ServerEditorProps> = ({server}) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      formData.append("inviteCode", server.inviteCode)
      formData.append("serverId", serverId); // You can append text data to the FormData as well

      try {
        const response = await fetch("/api/editServer", {
          method: "POST",
